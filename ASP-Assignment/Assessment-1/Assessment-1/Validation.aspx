<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Validation.aspx.cs" Inherits="Assessment_1.Validation" %>
...
<br />
            FamilyName :&nbsp;
<asp:TextBox ID="TextFamilyName" runat="server" Width="100px"></asp:TextBox>
&nbsp;&nbsp;
