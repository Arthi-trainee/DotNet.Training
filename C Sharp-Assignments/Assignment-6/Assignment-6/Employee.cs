...

    {
...

        {
...

            {
                ...
                Console.WriteLine("Employee ID:{0} Name: {1} City:{2} Salary:{3} ", All.EmplID, All.EmpName, All.EmplCity, All.EmplSal);
...

            {
                ...
                if (emp.EmplSal > 45000)

                    Console.WriteLine(emp.EmplName);
